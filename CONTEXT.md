...
A reviewed export projects that persisted review queue rather than re-deriving its items, so a receipt states exactly what was decided and covers exactly one run's review authority.
